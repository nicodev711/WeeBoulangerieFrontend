...
function HomePage() {
    return (
        <div className="p-8 bg-boulangerie-main" style={{ backgroundColor: '#f5f5f5' }}>
            <div className="mb-8">
                <h1 className="text-2xl md:text-4xl lg:text-4xl font-bold text-center mb-2" style={{ color: '#8c4322' }}>Welcome to The Wee Boulangerie!</h1>
                <p className="text-base md:text-lg lg:text-xl text-center" style={{ color: '#8c4322' }}>
                    We are a genuine artisan bakery in the heart of Edinburgh’s Southside.
                </p>
            </div>

            <FeaturedProducts/>

            <hr className="mt-8 mb-8 md:mt-12 md:mb-12" style={{ border: 'none', borderBottom: '2px solid #8c4322', width: '50%' }}/>

            <section className="mb-8">
                <h2 className="text-2xl md:text-4xl lg:text-4xl font-bold mb-4 text-boulangerie-main w-full text-center">About Us</h2>
                <div className="md:flex md:flex-row md:items-start mx-8">
                    <p className="text-base md:text-lg lg:text-xl">
                        <img src="/RealBreadLogo.png" alt="Real Bread Campaign Logo"
                         className="md:mr-4 mb-4 md:mb-0 rounded-2xl shadow-md md:float-left md:w-1/3 lg:w-1/4"
                         style={{ width: '50%', maxWidth: '200px', marginBottom: '1rem' }}/>
                        ...
                        There is no legal definition of “artisan”, “sourdough” and many other terms. There is not restriction
                        ...
                        see <a href="https://www.sustainweb.org/realbread/what_is_real_bread/"
                               ...
                               target="_blank" rel="noreferrer">What is Real Bread?</a> Our bread is Real Bread, and now you know exactly what you are eating.
                    </p>
                </div>
